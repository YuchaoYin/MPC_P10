      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          Eigen::VectorXd ptsx_wp = Eigen::VectorXd::Map(ptsx.data(), ptsx.size());
          Eigen::VectorXd ptsy_wp = Eigen::VectorXd::Map(ptsy.data(), ptsy.size());

          auto coeffs = polyfit(ptsx_wp, ptsy_wp, 3);
